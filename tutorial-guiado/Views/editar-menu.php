...
<html lang="pt-br">
   ...
   <body>
        <?php
            ...
            $stringQuery ="SELECT idMenus, nome, rotina, dataCriacao, usuario, revisaoTexto, revisaoPassos, ambienteDev,ambienteProd FROM menus WHERE idMenus = '".$id."';";
        ...
        <div class=centro-cadastro>
            ...
            <div><h1>Editar Menus</h1></div>

            <form method="POST" action="../PHP/editarM.php">
            
                <div>
                    <input type="hidden" name="idMenus" value="<?php echo $_GET['idMenus'];?>">
                </div>
                <div>
                    <label>Nome</label><br>
