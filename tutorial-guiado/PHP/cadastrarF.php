...
if (isset($erros) && count($erros) > 0) {
    ...
    $ambienteProd = addslashes($_POST['ambienteProd']);
	 ...
	 $stmt = $pdo->prepare("INSERT INTO fluxos (dataCriacao, nome, rotina, usuario, revisaoTexto, revisaoPassos, ambienteDev, ambienteProd) VALUES(:dataCriacao, :nome, :rotina, :usuario, :revisaoTexto, :revisaoPassos, :ambienteDev, :ambienteProd)");
